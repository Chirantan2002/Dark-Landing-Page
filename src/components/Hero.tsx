  ...
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <button
            className="bg-white text-black py-3 px-5 rounded-md font-medium transition-all duration-300 ease-in-out
    hover:text-white hover:scale-105 hover:shadow-lg
    bg-[linear-gradient(135deg,#f0d6ec,#0fb2eb,#1a65bc,#c05bb6,#121b3b,#f0d6ec)]
    bg-[length:300%_300%] bg-[position:0%_0%] hover:bg-[position:100%_40%]
    transition-[background-position] duration-700 ease-[cubic-bezier(.4,0,.2,1)] hover:shadow-[#0fb2eb]"
          >
            Get for free
          </button>
        </div>
